...
export type TipoRol = 'SUPER_ADMIN' | 'ADMIN' | 'USER' | 'VENDEDOR' | 'TALLER' | 'OFICINA' | 'USUARIO' | 'ADMIN_EMPRESA' | 'ADMIN_EMPRESA_LIMITADO' | 'GERENTE_SUCURSAL' | 'SUPERVISOR' | 'COBRANZAS' | 'TRANSPORTE' | 'RECURSOS_HUMANOS' | 'COORDINADORA_COMPRAS' | 'COORDINADORA_LOGISTICA' | 'LOGISTICO' | 'POST_VENTA' | 'CONDUCTOR';
