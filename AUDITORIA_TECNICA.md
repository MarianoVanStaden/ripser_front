...
- [~] **FRONT-003** Mismo split para `NotasPedidoPage` (2.590), `AsistenciasPage` (2.528), `PresupuestosPage` (2.232), `DeliveriesPage` (2.219), `ComprasPedidosPage` (2.115), `TransferenciasPage` (2.064). **Criterio ajustado (2026-05-03):** mismo trade-off que FRONT-002 — target < 2.000 LOC + dialogs/tabs/helpers extraídos a una subcarpeta por página, en lugar de < 500 LOC estricto. *Avance (2026-05-03):*
    ...
    - ***Total NotasPedidoPage: 2.590 → 1.827 LOC (-763, -29.5%).*** Quedan 2 dialogs inline (Billing ~116, Opciones Financiamiento ~77 = ~193 LOC más). Mismo patrón. Próximo paso opcional: Billing Dialog para llegar a ~1.700.*
    ...
    - *Pendiente en NotasPedidoPage (sesión próxima): 2 dialogs inline. Billing Dialog (~116 LOC) y Opciones Financiamiento Dialog (~77 LOC) — ~193 LOC totales. Mismo patrón que los 4 ya extraídos. Al completarlos el orquestador queda en ~1.700 LOC.*
